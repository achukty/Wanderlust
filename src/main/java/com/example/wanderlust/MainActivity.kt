        ...
        Column(
            ...
            )
            {
                Column(
                    ...
                    Text(
                        text = stringResource(id = R.string.title_activity_bali),
                        fontSize = 18.sp
                    )
                    ...
                    Text(
                        text = stringResource(id = R.string.title_activity_bali), color = Color.Gray,
                        fontSize = 16.sp
                    )
                }
            }
            ...
            )
            {
                Column(
                    ...
                    Text(
                        text = stringResource(id = R.string.title_activity_paris),
                        fontSize = 18.sp
                    )
                    ...
                    Text(
                        text = stringResource(id = R.string.title_activity_paris), color = Color.Gray,
                        fontSize = 16.sp
                    )
                }
            }
            ...
            )
            {
                Column(
                    ...
                    Text(
                        text = stringResource(id = R.string.title_activity_singapore),
                        fontSize = 18.sp
                    )
                    ...
                    Text(
                        text = stringResource(id = R.string.title_activity_singapore), color = Color.Gray,
                        fontSize = 16.sp
                    )
                }
            }
